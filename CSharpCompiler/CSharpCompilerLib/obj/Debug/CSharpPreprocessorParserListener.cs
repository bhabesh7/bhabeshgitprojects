...
public interface ICSharpPreprocessorParserListener : IParseTreeListener {
	...
	/// <summary>
	/// Enter a parse tree produced by <see cref="CSharpPreprocessorParser.preprocessor_directive"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterPreprocessor_directive([NotNull] CSharpPreprocessorParser.Preprocessor_directiveContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="CSharpPreprocessorParser.preprocessor_directive"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitPreprocessor_directive([NotNull] CSharpPreprocessorParser.Preprocessor_directiveContext context);
