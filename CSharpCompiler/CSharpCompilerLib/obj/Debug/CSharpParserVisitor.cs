...
public interface ICSharpParserVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitForeschStatement([NotNull] CSharpParser.ForeschStatementContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitUsing_directive([NotNull] CSharpParser.Using_directiveContext context);
